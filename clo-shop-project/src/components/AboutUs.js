  ...
  return (
    <div className="container">
      <div className={styles.AboutUs}>
        <img src={cloShop} className={styles.image} alt="closhop" />
